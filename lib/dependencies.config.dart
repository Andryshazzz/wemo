...
import 'package:wemo/repos/coin_repo.dart' as _i136;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.singleton<_i136.CoinRepository>(
      () => _i136.CoinRepository(apiClient: gh<_i80.ApiClient>()),
    );
    gh.factory<_i429.HomeBloc>(
      () => _i429.HomeBloc(repository: gh<_i136.CoinRepository>()),
    );
    return this;
  }
}
